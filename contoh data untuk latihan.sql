...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2021 at 08:25 AM
...
INSERT INTO `kode_golongan_darah` (`kode`, `keterangan`) VALUES
(1, 'A'),
(2, 'B'),
(3, 'AB'),
(4, '0'),
...
INSERT INTO `kode_kecamatan` (`kode_propinsi`, `kode_kabupaten`, `kode`, `keterangan`) VALUES
('16', '01', '11', 'Serang'),
('16', '01', '01', 'Cibeber'),
('16', '01', '02', 'Cilegon'),
('16', '01', '03', 'Pulomerak'),
...
INSERT INTO `kode_kelurahan` (`kode_propinsi`, `kode_kabupaten`, `kode_kecamatan`, `kode`, `keterangan`, `kode_gabung`) VALUES
('16', '01', '01', 1, 'Desa Kedaleman', '01'),
('16', '01', '01', 2, 'Cibeber', '02'),
('16', '01', '01', 3, 'Kalitimbang', '03'),
('16', '01', '01', 4, 'Karangasem', '04'),
('16', '01', '01', 5, 'Bulakan', '05'),
('16', '01', '01', 6, 'Cikerai', '06'),
('16', '01', '02', 7, 'Ciwaduk', '07'),
('16', '01', '02', 8, 'Ketileng', '08'),
('16', '01', '02', 9, 'Bendungan', '09'),
('16', '01', '02', 10, 'Ciwedus', '10'),
('16', '01', '02', 11, 'Bagendung', '11'),
('16', '01', '08', 12, 'Citangkil', '12'),
('16', '01', '08', 13, 'Tamanbaru', '13'),
('16', '01', '08', 14, 'Kebonsari', '14'),
('16', '01', '08', 15, 'Lebakdenok', '15'),
('16', '01', '08', 16, 'samangraya', '16'),
('16', '01', '08', 17, 'Warnasari', '17'),
('16', '01', '08', 18, 'Deringo', '18'),
('16', '01', '04', 19, 'Banjar Negara', '19'),
('16', '01', '04', 20, 'Kubangsari', '20'),
('16', '01', '04', 21, 'Tegalratu', '21'),
('16', '01', '04', 22, 'Kepuh', '22'),
('16', '01', '04', 23, 'Randakari', '23'),
('16', '01', '04', 24, 'Gunungsugih', '24'),
('16', '01', '06', 25, 'Grogol', '25'),
('16', '01', '06', 26, 'Kotasari', '26'),
('16', '01', '06', 27, 'Rawa Arum', '27'),
('16', '01', '06', 28, 'Gerem', '28'),
('16', '01', '05', 29, 'Jombang Wetan', '29'),
('16', '01', '05', 30, 'Panggung Rawi', '30'),
('16', '01', '05', 31, 'Gedong Dalem', '31'),
('16', '01', '05', 32, 'Masigit', '32'),
('16', '01', '05', 33, 'Sukmajaya', '33'),
('16', '01', '03', 34, 'Lebak Gede', '34'),
('16', '01', '03', 35, 'Mekarsari', '35'),
('16', '01', '03', 36, 'Tamansari', '36'),
('16', '01', '03', 37, 'Suralaya', '37'),
('16', '01', '07', 38, 'Ramanuju', '38'),
('16', '01', '07', 39, 'Kebondalem', '39'),
('16', '01', '07', 40, 'Kotabumi', '40'),
('16', '01', '07', 41, 'Pabean', '41'),
('16', '01', '07', 42, 'Purwakarta', '42'),
('16', '01', '07', 43, 'Tegal Bunder', '43'),
('16', '01', '11', 44, 'Kramatwatu', '44');
...
INSERT INTO `kode_kepakaran` (`kode`, `keterangan`) VALUES
('a', ' Kedokteran\n'),
('aa', ' Ilmu Biologi\n'),
('ab', ' Fisika Medis\n'),
('ac', ' Anatomik\n'),
...
('qb', ' Seni Suara\n'),
('qc', 'Guru Qiroati'),
('qz', 'Mengajar Matematik'),
('z', 'Hypnoterapis'),
(' -', ' -'),
('a1', 'Akupuntur'),
('rs', 'Rancang Bangun Sipil'),
('en', 'Engineering & Project Management'),
('pp', 'Production Planning Control'),
('ds', 'Design Engineering'),
('we', 'Metal & Electronik'),
('wa', 'Engineer'),
('lm', 'Bela Diri Kempo'),
('ts', 'Tahsin'),
...
('mj', 'Menjahit'),
('bk', 'Berdagang'),
('qq', 'Trainning Motivasi'),
('za', 'Pendidikan'),
('ik', 'Production Planning Control'),
('IO', 'HUMAN CAPITAL INTEGRASI & ADM');
...
INSERT INTO `kode_marital` (`kode`, `keterangan`) VALUES
('1', 'Belum Menikah'),
('2', 'Menikah'),
('3', 'Menikah dua istri'),
('4', 'Menikah tiga istri'),
('5', 'Menikah empat istri'),
('6', 'Duda/Janda');
...
CREATE TABLE `kode_pekerjaan` (
  `kode_bidang_pekerjaan` int(2) NOT NULL,
...
INSERT INTO `kode_pekerjaan` (`kode_bidang_pekerjaan`, `nama_bidang_pekerjaan`) VALUES
(1, 'Perkebunan deket rumah'),
(2, 'Lembaga keuangan'),
(3, 'Wedding Organiser / Dekorasi / Catering'),
(4, 'Jasa kemasyarakatan, sosial dan perorangan'),
(5, 'Angkutan, pergudangan dan komunikasi'),
(6, 'Pertambangan dan penggalian'),
(7, 'Listrik, gas dan air minum'),
(8, 'Industri pengolahan'),
(9, 'Konstruksi'),
(10, 'Pendidikan'),
(11, 'Statistika'),
(12, 'Percetakan, Service IT'),
(13, 'Bantuan Hukum dan HAM'),
(14, 'Perdagangan Buku Pendidikan Anak dan Parenting Skill'),
(15, 'Pertanian'),
(16, 'Perbankan'),
(17, 'Perawat'),
(18, 'Birokrat Pemda'),
...
(21, 'Peternakan'),
(22, 'Catring'),
(23, 'apoteker pengelola instalasi farmasi puskesmas'),
(24, 'Hardware komputer,Network,Trouble Shooting Windows'),
(25, 'Section head Level Staff'),
(26, 'Konsultan PNPM-MPd'),
(27, 'Kesehatan'),
(28, 'Kesenian'),
(29, 'Widyaiswara Badan Diklat'),
(30, 'Lingkungan Hidup'),
(31, 'Dosen'),
(32, 'Kepala Sekolah'),
(33, 'Wakil Kepala'),
(34, 'penyuluh pertanian'),
(35, 'pemberdayaan masyarakat'),
(36, 'Leasing/ Pembiayaan/ Finance'),
(37, 'pendidikan TPA'),
(38, 'Pengelola Bimbel'),
(39, 'Amil Zakat'),
(40, 'Ibu Rumah Tangga'),
(41, 'Agen ASURANSI'),
(42, 'Instruktur'),
(43, 'Usaha Catering Cake and Bakery'),
(44, 'Biro Kunsultasi Keluarga'),
(45, 'perdagangan'),
(46, 'asisten apoteker pengelola instalasi farmasi puskesmas'),
(47, 'perbendaharaan'),
(48, 'perbendaharaan'),
(49, 'Mengelola BMT'),
(50, 'perdagangan'),
...
(53, 'konsultan sipil'),
(54, 'Guru SD'),
(55, 'Pipin Engineering'),
(56, 'ENGINNER ( TEHNIK KIMIA )'),
(57, 'Praktek Dokter'),
(58, 'BIMBINGAN HAJI'),
(59, 'Medik veteriner-laboratorium'),
(60, 'Bidan'),
(61, 'Pendidikan'),
(62, 'Bidan'),
(63, 'PRODUCTION PLANING CONTROL'),
(64, 'HUMAN CAPITAL INTEGRASI & ADM'),
(65, 'Konsultan Mekanikal-Elektrikal'),
(66, 'Konsultan Mekanikal-Elektrikal'),
(67, 'Konsultan Mekanikal-Elektrikal'),
(68, 'Konsultan Mekanikal-Elektrikal'),
(69, 'Konsultan Mekanikal-Elektrikal'),
(70, 'Konsultan Mekanikal-Elektrikal'),
(71, 'Konsultan Mekanikal-Elektrikal'),
(72, 'Konsultan Mekanikal-Elektrikal'),
(73, 'Anggota DPRD Kota'),
(74, 'Petani'),
(75, 'pertanian'),
(76, 'Perencanaan Anggaran dan Kegiatan'),
(77, 'Perencanaan Pembangunan'),
(78, 'perkebunan'),
(79, 'Guru SMK'),
(80, 'Wiraswasta'),
(81, 'Dosen'),
...
(83, 'guru SMP'),
(84, 'Pengawas Sekolah'),
(85, 'Manajer / Kepala Cabang BUMN'),
(86, 'wira usaha'),
(87, 'DPRD Prop'),
(88, 'staf ahli fraksi dprd lamtim'),
(89, 'staf ahli fraksi dprd lamtim'),
(90, 'Refraksionis Optik'),
(91, 'PNS (Keuangan)'),
(92, 'lembaga Zakat'),
(93, 'Guru'),
(94, 'Guru Honor'),
(95, 'Operator SIMAK BMN'),
(96, 'Kuliah S2 Akuntansi'),
(97, 'Konsultan Pertambangan'),
(98, 'Konsultan Pertambangan'),
(99, 'Energi dan Kelistrikan'),
(100, 'Peradilan'),
(101, 'Karyawan Swasta'),
(102, 'Fungsional Penyuluh Agama Islam'),
(103, 'Manufactury'),
(104, 'Project'),
(105, 'Enginering'),
(106, 'Keperawatan'),
...
INSERT INTO `kode_program_studi` (`kode`, `nama`) VALUES
(0, '-'),
(2, 'Matematika Murni'),
(3, 'Kimia Murni'),
(4, 'Magister Teknologi Informasi'),
(5, 'Psikologi Perkembangan'),
(6, 'Statistika Terapan'),
...
(17, 'Pendidikan Matematika'),
(18, 'Pendidikan Matematika'),
(19, 'Sistem Informasi'),
(115, 'teknik kimia'),
(22, 'Ilmu Pemerintahan'),
(23, 'Ilmu Hukum'),
(24, 'Pendidikan Ekonomi'),
(25, 'TEKNOLOGI HASIL PERTANIAN'),
(26, 'Fisika Murni'),
(27, 'teknik sipil'),
(28, 'Teknik Elektro/Telekomunikasi'),
(29, 'ilmu manajemen'),
(30, 'Magister Ilmu Pemerintahan'),
(31, 'sosiologi'),
(32, 'Teknik Pertanian'),
(33, 'Syariah'),
(34, 'Ilmu Tanah'),
(35, 'Profesi Perawat'),
(36, 'Teknik Elektro/Tenaga Listrik'),
(37, 'Pendidikan Bahasa dan Sastra Indonesia'),
(38, 'Pendidikan Bahasa dan Sastra Indonesia'),
(39, 'Komunikasi Penyiaran Islam'),
(40, 'Komunikasi Penyiaran Islam'),
(41, 'Ilmu Komunikasi'),
(42, 'Fakultas Farmasi'),
(43, 'Administrasi Negara'),
(44, 'pendidikan kimia'),
(45, 'Bimbingan dan Konseling'),
(46, 'Keperawatan'),
(47, 'Administrasi Bisnis'),
(48, 'Teknik Mesin'),
(49, 'Teknik Mesin'),
(50, 'Pendidikan Olahraga'),
(51, 'Ekonomi Pembangunan'),
(52, 'Tarbiyah'),
(53, 'Tarbiyah'),
(54, 'Pendidikan Biologi'),
(55, 'Pendidikan Sejarah'),
(56, 'Pendidikan Bahasa Inggris'),
(57, 'Tarbiyah/Pendidikan Agama Islam'),
(58, 'Sastra Perancis'),
(59, 'Kimia Murni'),
(60, 'Peternakan'),
(61, 'Produksi Ternak'),
(62, 'Teknologi Aquakultur'),
(63, 'Agrobisnis'),
(64, 'pendidikan fisika'),
(65, 'MIPA Biologi'),
(66, 'tarbiyah'),
(67, 'Budidaya Pertanian/Agronomi'),
(68, 'Magister Ekonomi Pertanian/Agribisnis'),
(69, 'Agronomi'),
(70, 'sastra dan bahasa Inggris'),
(71, 'MIPA FISIKA'),
(72, 'Ilmu Hama dan Penyakit Tanaman'),
(73, 'Pendidikan Agama Islam'),
(74, 'Teknik Lingkungan'),
(75, 'Ilmu Managament'),
(76, 'Matematika Murni'),
(77, 'Budidaya Pertanian/Hortikultura'),
(78, 'Budidaya Pertanian/Hortikultura'),
(79, 'Kehutanan'),
(80, '-'),
(81, '-'),
(82, 'Kimia Murni'),
...
(85, 'MIPA Kimia'),
(86, 'Sistem Komputer'),
(87, 'pengembangan masyarakat islam'),
(88, 'pengembangan masyarakat islam'),
(89, 'Kehutanan'),
(90, 'Kedokteran Hewan'),
(91, 'Kedokteran Gigi'),
(92, 'Pendidikan Bahasa Arab'),
(93, 'Pendidikan Agama Islam'),
(94, 'manajemen proyek'),
(95, 'Pendidikan Guru SD'),
(96, 'Pendidikan kewarganegaraan'),
(97, 'Bidan Pendidik'),
(98, 'Magister Kesehatan Masyarakat'),
(99, 'Kedokteran Umum'),
(100, 'penyuluh pertanian'),
(101, 'penyuluh pertanian'),
(102, '-'),
(103, '-'),
(104, 'Arsitektur'),
(105, 'arsitektur'),
(106, 'Kebidanan'),
(107, 'Farmasi'),
(108, 'Kesehatan Masyarakat'),
(109, 'Ekonomi Manajemen'),
(110, 'Pendidikan Bahasa dan Sastra Indonesia'),
(111, 'Kedokteran Hewan'),
(112, 'tdk s2'),
(113, 'tdk s3'),
(114, 'Akuntansi Islam'),
(116, 'Budidaya Pertanian'),
(117, '-'),
(118, '-'),
(119, 'Magister Manajemen'),
(120, 'Ilmu Tanah'),
(121, 'Pemasaran (Marketting)'),
(122, 'ips sejarah'),
(123, 'ips sejarah'),
(124, 'ips sejarah'),
(125, 'ips sejarah'),
(126, 'Ilmu Tanah'),
(127, 'Pendidikan Luar Sekolah'),
(128, 'Ilmu Geografi'),
(129, 'Budidaya Perairan/ Perikanan'),
(130, 'Ilmu Pemerintahan'),
(131, 'Teknik Pertambangan'),
(132, 'Teknik Pertambangan'),
(133, 'Ilmu Lingkungan BKU. Perencanaan Pengelolaan SDA'),
(134, 'Teknik Pertambangan'),
(135, 'Ilmu Lingkngan BKU. Perencanaan Pengelolaan SDA'),
(136, 'Islamic Studies'),
(137, 'Teknologi Pangan dan Gizi'),
(138, 'Dakwah'),
(139, 'Pengembangan Masyarakat Islam'),
(140, 'syariah'),
(141, 'syariah'),
(142, 'Ilmu Komputer'),
(143, 'matematika'),
...
INSERT INTO `kode_suku` (`kode`, `keterangan`) VALUES
(1, 'Jawa'),
(5, 'Madura'),
(9, 'Palembang'),
(13, 'Betawi'),
...
INSERT INTO `kode_tingkat_pendidikan` (`kode`, `keterangan`) VALUES
(1, 'Tidak Tamat SD'),
(2, 'SD/MI'),
(3, 'SMP/MTs'),
(4, 'SMA/MA/SMK'),
...
INSERT INTO `manusia` (`Nomor_Data`, `Nama_Lengkap`, `Jenis_Kelamin`, `Tempat_Lahir`, `Tanggal_Lahir`, `Alamat`, `RT`, `RW`, `Kecamatan`, `Kelurahan`, `Status_Marital`, `Suku`, `Tingkat_Pendidikan`, `Program_Studi`, `Golongan_Darah`, `Telpon`, `Email`, `Pekerjaan`, `Nama_Istri`, `Nama_Anak_ke_1`, `Tanggal_Lahir_Anak_ke_1`, `Nama_Anak_ke_2`, `Tanggal_Lahir_Anak_ke_2`, `Nama_Anak_ke_3`, `Tanggal_Lahir_Anak_ke_3`, `Nama_Anak_ke_4`, `Tanggal_Lahir_Anak_ke_4`, `Nama_Anak_ke_5`, `Tanggal_Lahir_Anak_ke_5`, `Nama_Anak_ke_6`, `Tanggal_Lahir_Anak_ke_6`, `Nama_Anak_ke_7`, `Tanggal_Lahir_Anak_ke_7`, `Organisasi_1`, `Organisasi_2`, `Organisasi_3`) VALUES
(3, 'Parto Sunarto', 'P', 'Jogyakarta', '1968-12-20', 'Jl. Maju Mundur', '04', '05', '01', 1, '2', 6, 6, 48, 4, '08202665016', 'sayur@gmail.com', 101, 'Nini Kartini', 'Udin Surudin', NULL, 'Mahir Zein', NULL, 'Galang Menggalang', NULL, 'Kerja Bakti', NULL, 'Zidan', NULL, '-', NULL, '-', NULL, '-', '-', '-'),
(4, 'Mukidi', 'L', 'Lampung', '1978-09-09', 'Tanjung Senang', '04', '05', '03', 1, '2', 1, 7, 135, 4, '0898328704651', 'mukidi@yahoo.com', 91, 'Tri Putri Metri', 'Indah', NULL, 'Dede', NULL, 'Elvi', NULL, '-', NULL, '-', NULL, '-', NULL, '-', NULL, '-', '-', '-'),
(6, 'Mulyadi', 'L', 'Sukoharjo', '1972-07-03', 'Perumahan Murah Meriah', '-', '-', '01', 3, '2', 1, 7, 8, 1, '0811232341234', 'mulyadi@yahoo.com', 85, 'Nini', 'Pulo', NULL, 'Kiki', NULL, 'Sarah', NULL, '-', NULL, '-', NULL, '-', NULL, '-', NULL, '-', '-', '-'),
...
INSERT INTO `rekap` (`Kode`, `Keterangan`, `Jumlah`) VALUES
('L', 'Laki-Laki', 512),
('P', 'Perempuan', 300);
...
--
-- Indexes for table `kode_golongan_darah`
--
ALTER TABLE `kode_golongan_darah`
  ADD PRIMARY KEY (`kode`);

--
-- Indexes for table `kode_keahlian`
--
ALTER TABLE `kode_keahlian`
  ADD PRIMARY KEY (`Kode`);
...
ALTER TABLE `kode_kecamatan`
  ADD PRIMARY KEY (`kode_propinsi`,`kode_kabupaten`,`kode`),
  ADD KEY `kode_propinsi` (`kode_propinsi`,`kode_kabupaten`,`kode`),
  ADD KEY `keterangan` (`keterangan`);

--
-- Indexes for table `kode_kelurahan`
--
ALTER TABLE `kode_kelurahan`
  ADD PRIMARY KEY (`kode`),
  ADD KEY `kode_propinsi` (`kode_propinsi`,`kode_kabupaten`,`kode_kecamatan`,`kode`),
  ADD KEY `keterangan` (`keterangan`);

--
-- Indexes for table `kode_kepakaran`
--
ALTER TABLE `kode_kepakaran`
  ADD PRIMARY KEY (`kode`);

--
-- Indexes for table `kode_marital`
--
ALTER TABLE `kode_marital`
  ADD PRIMARY KEY (`kode`);
...
ALTER TABLE `kode_pekerjaan`
  ADD PRIMARY KEY (`kode_bidang_pekerjaan`);

--
-- Indexes for table `kode_program_studi`
--
ALTER TABLE `kode_program_studi`
  ADD PRIMARY KEY (`kode`);

--
-- Indexes for table `kode_suku`
--
ALTER TABLE `kode_suku`
  ADD PRIMARY KEY (`kode`);

--
-- Indexes for table `kode_tingkat_pendidikan`
--
ALTER TABLE `kode_tingkat_pendidikan`
  ADD PRIMARY KEY (`kode`);
...
--
-- AUTO_INCREMENT for table `kode_keahlian`
--
ALTER TABLE `kode_keahlian`
  MODIFY `Kode` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kode_kelurahan`
--
ALTER TABLE `kode_kelurahan`
  MODIFY `kode` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `kode_pekerjaan`
--
ALTER TABLE `kode_pekerjaan`
  MODIFY `kode_bidang_pekerjaan` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;

--
-- AUTO_INCREMENT for table `kode_program_studi`
--
ALTER TABLE `kode_program_studi`
  MODIFY `kode` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;

--
-- AUTO_INCREMENT for table `manusia`
--
ALTER TABLE `manusia`
  MODIFY `Nomor_Data` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
