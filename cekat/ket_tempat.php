...
<?php
include "koneksi.php";
$tampil=mysqli_query($conn,"SELECT * FROM ket_tempat");
	foreach($tampil as $kuy){
		echo "
		<tr>
		<td>".$kuy['ket_tempat']."</td>
		<td><a href= hapus.php?id=$kuy[id]>Hapus</a></td>
		</tr>
		";
		}
...
<tr>
	...
	<td align="center"><a href="tambah.php?" type="submit">Tambah</a></td>
</tr>
</table>
</div>
<div id="footer">
